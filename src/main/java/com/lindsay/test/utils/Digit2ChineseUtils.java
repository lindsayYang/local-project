...
/**
 * Digit2ChineseUtils 阿拉伯数字转中文
 *
 * @author Lindsay
 * @date 2019/8/9 17:50
 * @since 0.7.0
 **/
public class Digit2ChineseUtils {

  private Digit2ChineseUtils() {
  ...
  private static String[] convert(long num, boolean isColloquial) {
    ...
    List<String> cnchars = new ArrayList<String>(chars.length * 2);// 创建数组，将数字填入单位对应的位置

...
public class OrderMapTest {
    ...
    public static void main(String[] args) {
        ...
        orderLocation.put("X", "116.515487");
        orderLocation.put("Y", "39.905453");
        // 商业区域（百度多边形区域经纬度集合）
        String partitionLocation = "39.908766_116.495451,39.908503_116.515664,39.893148_116.517225,39.892605_116.497742";
        System.out.println(isInPolygon(orderLocation, partitionLocation));

        Point2D.Double point = new Point2D.Double(116.516002,39.908449);
        List<Point2D.Double> polygon = new ArrayList<>();
        polygon.add(new Point2D.Double(116.495451, 39.908766));
        polygon.add(new Point2D.Double(116.515664, 39.908503));
        polygon.add(new Point2D.Double(116.517225, 39.893148));
        polygon.add(new Point2D.Double(116.497742, 39.892605));
        boolean b = checkWithJdkGeneralPath(point, polygon);
